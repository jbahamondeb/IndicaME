...
@Component({
  selector: 'ngx-country-orders-comuna-chart',
  templateUrl: './country-orders-comuna-chart.component.html',
  styleUrls: ['./country-orders-comuna-chart.component.scss']
})
export class CountryOrdersComunaChartComponent  implements AfterViewInit, OnDestroy, OnChanges {
              ...
              onEventStartEndRange(event:any){
                ...
                if(event.start){
                  ...
                  if(event.end){
                    ...
                    this.countryOrder.getCountriesCategoriesData('13101')
                    .pipe(takeWhile(() => this.alive))
